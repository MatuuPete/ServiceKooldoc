...
<div class="modal fade" id="addFeedback2Modal" tabindex="-1" aria-labelledby="addFeedback2ModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addFeedback2ModalLabel">SERVICE FEEDBACK</h1>
            ...
            <div class="modal-footer">
                ...
                <button id="add_feedback2" type="button" class="btn btn-primary">Submit</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="addPostConsultation2Modal" tabindex="-1" aria-labelledby="addPostConsultation2ModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addPostConsultation2ModalLabel">POST CONSULTATION</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                <button id="add_post_consultation2" type="button" class="btn btn-primary">Send</button>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Completed Follow-up Booked Service</h4>
                <div class="table-responsive">
                    <table id="completed_followup_booked_service" class="table table-striped text-capitalize">
                        <thead>
                            <tr>
                                <th>
                                    SERVICE ID
