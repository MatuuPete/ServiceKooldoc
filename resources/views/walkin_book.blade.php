        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto text-center">
                    <h2 class="title">Walk-in Book</h2>
                </div>
            </div>
            <div class="row">
                <div class="card col-md-10 mx-auto shadow-lg">
                    <ul class="nav nav-tabs text-center" id="bookServiceTab" role="tablist">
                        ...
                        <li class="nav-item col-md-3">
                            <a class="nav-link p-3" id="step4-tab" data-toggle="tab" href="#step4" role="tab" aria-controls="step4" aria-selected="false">Step 4 of 5<br>Select Customer</a>
                        </li>
                        <li class="nav-item col-md-2">
                    ...
                    <form id="book_service_form" enctype="multipart/form-data">
                        <div class="tab-content" id="bookServiceTabContent">
                            ...
                            <div class="tab-pane fade" id="step4" role="tabpanel" aria-labelledby="step4-tab">
                                <div class="container">
                                    <div id="selected_customer_info" class="row">
                                        <div class="col-4">
                                            <div class="form-group mt-3" id="customer-list">
                                                <label for="customer_id">Select Customer:</label>
                                            </div>
                                            {{-- <div class="form-group mt-3">
                                                <label for="selected_book_barangay">Barangay</label>
                                                <input id="selected_book_barangay" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_barangay" disabled>
                                            </div>
                                            <div class="form-group mt-3">
                                                <label for="selected_book_city">City</label>
                                                <input id="selected_book_city" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_city" disabled>
                                            </div>
                                            <div class="form-group mt-3">
                                                <label for="selected_book_property_type">Property Type</label>
                                                <input id="selected_book_property_type" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_property_type" disabled>
                                            </div> --}}
                                        </div>

                                        {{-- <div class="col-4">
                                            <div class="form-group mt-3">
                                                <label for="selected_book_first_name">First Name</label>
                                                <input id="selected_book_first_name" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_first_name" disabled>
                                            </div>
                                            <div class="form-group mt-3">
                                                <label for="selected_book_province">Province</label>
                                                <input id="selected_book_province" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_province" disabled>
                                            </div>
                                            <div class="form-group mt-3">
                                                <label for="selected_book_zip_code">Zip Code</label>
                                                <input id="selected_book_zip_code" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_zip_code" disabled>
                                            </div>
                                        </div>

                                        <div class="col-4">
                                            <div class="form-group mt-3">
                                                <label for="selected_book_last_name">Last Name</label>
                                                <input id="selected_book_last_name" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_last_name" disabled>
                                            </div>
                                            <div class="form-group mt-3">
                                                <label for="selected_book_address">Address</label>
                                                <textarea id="selected_book_address" type="text" class="form-control form-control-lg form-control form-control-lg-lg text-capitalize" name="selected_book_address" placeholder="House No. & Block/Lot No. & Street No./Name" disabled></textarea>
                                            </div>
                                        </div> --}}
                                    </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group mt-3">
                                                <label for="payment_proof">Payment proof <span class="text-muted fst-italic">(You can skip this)</span></label><br>
                                                <input type="text" id="image-name" class="form-control form-control-lg" readonly><br>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div>
                                                        <span class="btn btn-raised btn-round btn-primary btn-file">
                                                            <span class="fileinput-new">Add Photo</span>
                                                            <input type="file" id="payment_proof" name="payment_proof" accept=".jpeg,.jpg,.png" />
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-center mt-3 mb-3">
                                        ...
                                        <button id="walkin_btn" class="btn btn-primary btn-lg">Book Service</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    document.getElementById('payment_proof').onchange = function () {
        document.getElementById('image-name').value = this.value.split("\\").pop();
    }
</script>
