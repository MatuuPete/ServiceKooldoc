    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addSuperAdminModalLabel">ADD SUPER ADMIN</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="add_super_admin_form">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button id="add_super_admin" type="button" class="btn btn-primary">Add</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editSuperAdminModal" tabindex="-1" aria-labelledby="editSuperAdminModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editSuperAdminModalLabel">EDIT SUPER ADMIN</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="edit_super_admin_form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="super_admin_id" name="super_admin_id" type="text" class="form-control" disabled>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                <button id="edit_super_admin" type="button" class="btn btn-primary">Update</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title">All Super Admin</h4>
                    <h4 class="card-title">Add
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addSuperAdminModal"><i class="mdi mdi-plus"></i></button>
                    </h4>
                </div>
                <div class="table-responsive">
                    <table id="all_super_admin" class="table table-striped text-capitalize">
                        <thead>
                            <tr>
                                <th>
                                    SUPER ADMIN ID
