...
<div class="modal fade" id="editSuperAdminProfileModal" tabindex="-1" aria-labelledby="editSuperAdminProfileModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editSuperAdminProfileModalLabel">EDIT SUPER ADMIN PROFILE</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="edit_super_admin_profile_form" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button id="edit_super_admin_profile" type="button" class="btn btn-primary">Update</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row shadow-lg">
                <div class="col-sm-4 bg-primary rounded-left d-flex align-items-center justify-content-center">
                    <div class="card-block text-center text-white mt-4 mb-3">
                        ...
                        <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#editSuperAdminProfileModal"><i class="mdi mdi-pencil"></i></button>
                    </div>
                </div>                  
                <div class="col-sm-8 bg-white rounded-right">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            <p class="font-weight-bold">Team Position</p>
                            <h6 class="text-muted"><span id="profile_team"></span></h6>
                        </div>
                    </div>
                </div>
            </div>
