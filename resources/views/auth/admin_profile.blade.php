    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editAdminProfileModalLabel">EDIT ADMIN PROFILE</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="edit_admin_profile_form" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button id="edit_admin_profile" type="button" class="btn btn-primary">Update</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row shadow-lg">
            <div class="col-sm-4 bg-primary rounded-left d-flex align-items-center justify-content-center">
                <div class="card-block text-center text-white mt-4 mb-3">
                    ...
                    <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#editAdminProfileModal"><i class="mdi mdi-pencil"></i></button>    
                </div>
            </div>                  
