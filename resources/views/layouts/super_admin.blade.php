...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-scroller">
            @include('layouts.inc.super_admin.navbar')
            <div class="container-fluid page-body-wrapper">
                @include('layouts.inc.super_admin.sidebar')
        ...
        <script src="{{ asset('admin/js/super_admin.js') }}"></script>
        <script src="{{ asset('admin/js/tables.js') }}"></script>
        <script src="{{ asset('admin/js/statuses.js') }}"></script>
