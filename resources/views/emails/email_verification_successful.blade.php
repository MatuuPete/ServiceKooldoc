        ...
        <div class="container">
            <div class="row">
                <div class="card col-md-10 mx-auto custom-my p-5 text-center shadow-lg">
                    <div>
                        <h1 class="text-primary">EMAIL VERIFICATION SUCCESSFUL</h1>
                        <i class="fa fa-check-circle text-primary fa-5x mb-3"></i>
                        <p class="lead">Thank you for verifying your email. Happy booking!</p>
                        <p class="lead">You may now close this tab and return to our website.</p>
                    </div>
                </div>
            </div>
        </div>
