...
class AdminFollowupServiceCreatedNotification extends Mailable
{
    ...
    {
        return $this->markdown('emails.admin-followup-service-created')
            ->subject('Customer Follow-up Service')
            ->with([
